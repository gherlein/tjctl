...
typedef struct {
	...
	unsigned long half_pulses[20];		/* Contains the time stamps of
						   incoming half pulses. */
	unsigned char half_pulses_detected;	/* Contains the number of half
						   pulses detected. */
